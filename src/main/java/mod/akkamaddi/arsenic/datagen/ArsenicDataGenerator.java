    ...
    public static void gatherData(GatherDataEvent event)
    {
        ...
        gen.addProvider(event.includeServer(), 
            	new SimpleLootTableProvider(packOutput, List.of(
            			new LootTableProvider.SubProviderEntry(ArsenicLootTableSubprovider::new, LootContextParamSets.BLOCK),
                		new LootTableProvider.SubProviderEntry( ArsenicLootInjectorSubprovider::new, LootContextParamSets.CHEST)
                		)));
